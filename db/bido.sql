...
--
ALTER TABLE `admin` ADD PRIMARY KEY (`AD_id`);

--
-- Indexes for table `cfm`
--
ALTER TABLE `cfm` ADD PRIMARY KEY (`c_id`);
...
--
ALTER TABLE `worker` ADD PRIMARY KEY (`wo_id`);
...
--
ALTER TABLE `admin` MODIFY `AD_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cfm`
--
ALTER TABLE `cfm` MODIFY `c_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `c_pay`
--
ALTER TABLE `c_pay` MODIFY `p_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `metro`
--
ALTER TABLE `metro` MODIFY `m_id` int(11) NOT NULL AUTO_INCREMENT;
